        ...
        <div className="row m-0 my-5">
          ...
          <div className="row m-0 mt-5">
            <div className="container col-12 col-md-4 col-lg-3 mx-auto mb-4">
              <h3><i className="fa fa-laptop basic-color" aria-hidden="true" /> Frontend</h3>
              <p className="p-2 font-poiret-p">
                Building the visual parts of the app, from prototypes and mockups to a valuable product using the 
                latest technologies and frameworks such as JavaScript(ES6), HTML5, CSS3 & SASS, React and Bootstrap 4. 
                With a focus to create responsive websites that work on a wide range of devices to assist the production 
                of clean and functional design. 
                </p>
            </div>
            <div className="container col-12 col-md-4 col-lg-3 mx-auto mb-4">
              <h3><i className="fa fa-server basic-color" aria-hidden="true" /> Backend</h3>
              <p className="p-2 font-poiret-p">
